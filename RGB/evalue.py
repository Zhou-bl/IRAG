...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--instruction_path', type=str, default='config/instruction.yaml',
        help='instruction path'
    )
    parser.add_argument(
    ...
    if args.factchecking:
        ...
        prompt = yaml.load(open(args.instruction_path, 'r'), Loader=yaml.FullLoader)[args.dataset[:2]]
